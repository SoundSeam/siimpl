...
import { acceptAdminInvite } from "@/lib/portal-actions";
  ...
  return (
    <main className="flex min-h-dvh bg-neutral-100 px-6 py-8 text-neutral-950">
      <section className="m-auto w-full max-w-[24rem]">
        ...
        />
        <form action={acceptAdminInvite} className="mt-10 text-center">
          <h1 className="text-2xl font-semibold tracking-[-0.03em]">Siimpl admin</h1>
